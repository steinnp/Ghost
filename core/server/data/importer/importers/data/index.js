var _ = require('lodash'),
    ...
    SubscribersImporter = require('data/importer/importers/data/subscribers'),
    PostsImporter = require('data/importer/importers/data/posts'),
    TagsImporter = require('data/importer/importers/data/tags'),
    SettingsImporter = require('data/importer/importers/data/settings'),
    UsersImporter = require('data/importer/importers/data/users'),
    RolesImporter = require('data/importer/importers/data/roles'),
    importers = {},
    DataImporter;

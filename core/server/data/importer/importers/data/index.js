var _ = require('lodash'),
    ...
    SubscribersImporter = requireRoot('data/importer/importers/data/subscribers'),
    PostsImporter = requireRoot('data/importer/importers/data/posts'),
    TagsImporter = requireRoot('data/importer/importers/data/tags'),
    SettingsImporter = requireRoot('data/importer/importers/data/settings'),
    UsersImporter = requireRoot('data/importer/importers/data/users'),
    RolesImporter = requireRoot('data/importer/importers/data/roles'),
    importers = {},
    DataImporter;

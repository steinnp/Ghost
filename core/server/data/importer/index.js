var _ = require('lodash'),
    ...
    ImageHandler = requireRoot('data/importer/handlers/image'),
    JSONHandler = requireRoot('data/importer/handlers/json'),
    MarkdownHandler = requireRoot('data/importer/handlers/markdown'),
    ImageImporter = requireRoot('data/importer/importers/image'),
    DataImporter = requireRoot('data/importer/importers/data'),

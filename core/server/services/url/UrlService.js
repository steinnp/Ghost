...
const _ = require('lodash'),
    ...
    resourceConfig = require('services/url/config.json'),
    Resource = require('services/url/Resource'),
    urlCache = require('services/url/cache'),
    localUtils = require('services/url/utils');

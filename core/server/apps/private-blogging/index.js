var config = require('config'),
    ...
    middleware = require('apps/private-blogging/lib/middleware'),
    router = require('apps/private-blogging/lib/router'),
    registerHelpers = require('apps/private-blogging/lib/helpers'),
    checkSubdir;

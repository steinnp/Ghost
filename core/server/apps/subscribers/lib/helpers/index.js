...
module.exports = function registerHelpers(ghost) {
    ghost.helpers.register('input_email', require('apps/subscribers/lib/helpers/input_email'));
    ...
    ghost.helpers.register('subscribe_form', function labsEnabledHelper() {
        ...
        return labs.enabledHelper({
            ...
            return require('apps/subscribers/lib/helpers/subscribe_form').apply(self, args);
        });
    });
};

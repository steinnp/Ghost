var Promise = require('bluebird'),
    ...
    mail = requireRoot('services/mail'),
    urlService = requireRoot('services/url'),
    localUtils = requireRoot('api/utils'),
    models = requireRoot('models'),
    spamPrevention = requireRoot('web/middleware/api/spam-prevention'),
    mailAPI = requireRoot('api/mail'),
    settingsAPI = requireRoot('api/settings'),
    authentication,
    tokenSecurity = {};

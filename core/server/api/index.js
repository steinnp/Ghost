...
var _ = require('lodash'),
    ...
    configuration = require('api/configuration'),
    db = require('api/db'),
    ...
    invites = require('api/invites'),
    redirects = require('api/redirects'),
    clients = require('api/clients'),
    users = require('api/users'),
    slugs = require('api/slugs'),
    themes = require('api/themes'),
    subscribers = require('api/subscribers'),
    authentication = require('api/authentication'),
    uploads = require('api/upload'),

...
var _ = require('lodash'),
    ...
    configuration = requireRoot('api/configuration'),
    db = requireRoot('api/db'),
    mail = requireRoot('api/mail'),
    notifications = requireRoot('api/notifications'),
    posts = requireRoot('api/posts'),
    schedules = requireRoot('api/schedules'),
    roles = requireRoot('api/roles'),
    settings = requireRoot('api/settings'),
    tags = requireRoot('api/tags'),
    invites = requireRoot('api/invites'),
    redirects = requireRoot('api/redirects'),
    clients = requireRoot('api/clients'),
    users = requireRoot('api/users'),
    slugs = requireRoot('api/slugs'),
    themes = requireRoot('api/themes'),
    subscribers = requireRoot('api/subscribers'),
    authentication = requireRoot('api/authentication'),
    uploads = requireRoot('api/upload'),
    exporter = requireRoot('data/export'),
    slack = requireRoot('api/slack'),
    webhooks = requireRoot('api/webhooks'),

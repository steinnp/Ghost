var debug = require('ghost-ignition').debug('app'),
    ...
    // local middleware
    ghostLocals = require('web/middleware/ghost-locals'),
    logRequest = require('web/middleware/log-request');
...
module.exports = function setupParentApp() {
    ...
    parentApp.use('/ghost/api/v0.1/', require('web/api/app')());

    // ADMIN
    parentApp.use('/ghost', require('web/admin')());

    // BLOG
    parentApp.use(require('web/site')());
